...
import com.laison.nlapis.common.constants.ContentConstant;
import com.laison.nlapis.common.validatgroup.AddGroup;
import com.laison.nlapis.common.validatgroup.UpdateGroup;
import com.laison.nlapis.model.common.Result;
...
public class ${entity_name}Controller {
	...
	@PreAuthorize("hasAuthority('${model_name}:add')")
	...
	@PreAuthorize("hasAuthority('${model_name}:update')")
	...
	@PreAuthorize("hasAuthority('${model_name}:delete')")
